...
public class ScreenModuleChoice extends ScreenBase {
	...
	public ScreenModuleChoice(GuiScreen parent){
		...
		this.getRoot().getWidget("ButtonContainer").setGeometry(new WidgetGeometry(50.0, 20.0, 400.0, 60.0, CoordType.RELXY, CoordType.RELY, WidgetAlign.CENTER, WidgetAlign.TOP));
