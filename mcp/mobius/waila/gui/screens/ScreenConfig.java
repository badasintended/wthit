...
public class ScreenConfig extends ScreenBase {
	public ScreenConfig(GuiScreen parent){
		...
		this.getRoot().getWidget("ButtonContainer").setGeometry(new WidgetGeometry(50.0, 50.0, 50.0, 30.0, true, true, true, false, WidgetGeometry.Align.CENTER, WidgetGeometry.Align.CENTER));	
		...
		buttonContainer.addButton( new ButtonScreenChange(this.getRoot(), "Modules", new ScreenWailaConfig(this)));
