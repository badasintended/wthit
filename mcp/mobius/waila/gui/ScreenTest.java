...
import mcp.mobius.waila.gui.widgets.Label;
...
public class ScreenTest extends ScreenBase {
	...
	public ScreenTest(GuiScreen parent) {
		...
		this.getRoot().getWidget("Picture").setGeometry(new WidgetGeometry(50.0, 50.0, 50.0, 50.0, true, true, WidgetGeometry.Align.CENTER, WidgetGeometry.Align.CENTER));
		
		this.getRoot().addWidget("Text", new Label(this.getRoot(), "waila:textures/test.png"));
