...
public interface IWailaDataProvider {
     ...
     */
    default ItemStack getStack(IWailaDataAccessor accessor, IWailaConfigHandler config) {
        return ItemStack.EMPTY;
    }

    /**
     * Callback used to add lines to one of the three sections of the tooltip (Head, Body, Tail).</br>
     * Will only be called if the implementing class is registered via {@link IWailaRegistrar#registerComponentProvider(IWailaDataProvider, TooltipPosition, Class)}.</br>
     ...
     * @param config     Current configuration of Waila.
     */
    default void appendHead(List<TextComponent> tooltip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
     ...
     * @param config     Current configuration of Waila.
     */
    default void appendBody(List<TextComponent> tooltip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
     ...
     * @param config     Current configuration of Waila.
     */
    default void appendTail(List<TextComponent> tooltip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
