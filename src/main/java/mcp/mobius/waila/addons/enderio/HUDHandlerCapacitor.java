        ...
        if (accessor.getPlayer().isSneaking()) {
            try {
                ...
                if (config.getConfig("enderio.storage")) {
                    Integer maxEnergyStored = (Integer) PluginEnderIO.TCB_getMaxEnergyStored.invoke(accessor.getTileEntity());
                    Double energyStored = (Double) PluginEnderIO.TCB_getEnergyStored.invoke(accessor.getTileEntity());
                ...
                if (config.getConfig("enderio.inout")) {
                    Integer maxIO = (Integer) PluginEnderIO.TCB_getMaxIO.invoke(accessor.getTileEntity());
                    Integer maxInput = (Integer) PluginEnderIO.TCB_getMaxInput.invoke(accessor.getTileEntity());
                    Integer maxOutput = (Integer) PluginEnderIO.TCB_getMaxOutput.invoke(accessor.getTileEntity());
