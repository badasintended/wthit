...
public class Waila {
    ...
    public static final SimpleChannel NETWORK = NetworkRegistry.ChannelBuilder.named(new Identifier(MODID, "networking"))
    ...
    public static final Tag<Block> BLOCK_BLACKLIST = BlockTags.createOptional(new Identifier(MODID, "blacklist"));
    public static final Tag<EntityType<?>> ENTITY_BLACKLIST = EntityTypeTags.createOptional(new Identifier(MODID, "blacklist"));
    ...
    public void playerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        NETWORK.sendTo(new MessageServerPing(PluginConfig.INSTANCE), ((ServerPlayerEntity) event.getPlayer()).networkHandler.connection, NetworkDirection.PLAY_TO_CLIENT);
    }
