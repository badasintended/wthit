...
public class MessageRequestTile implements IMessage {
            ...
            server.addScheduledTask(new Runnable() {
                ...
                public void run() {
                    ...
                    if (hasNBTBlock || hasNBTEnt) {
                        ...
                        tag.setString("id", getTileId(tile));
                    ...
                    tag.setString("WailaID", getTileId(tile));
    ...
    private static String getTileId(TileEntity tile) {
        String id = "";
        try {
            Map<Class<? extends TileEntity>, String> classToName = (Map<Class<? extends TileEntity>, String>) Constants.TE_CLASS_TO_NAME.get(null);
            id = classToName.get(tile.getClass());
            if (id == null)
                id = "";
        } catch (Exception e) {
            // nope
