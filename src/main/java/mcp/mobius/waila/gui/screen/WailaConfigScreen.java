...
public class WailaConfigScreen extends ConfigScreen {
    ...
    private class PlacementScreen extends YesIAmSureTheClientInstanceIsPresentByTheTimeIUseItScreen {
        ...
        protected void init() {
            ...
            addRenderableWidget(done = new Button(0, 0, 102, 20, CommonComponents.GUI_DONE, (b) -> {
        ...
        public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
            ...
            // @formatter:off
            GuiComponent.drawString(matrices, minecraft.font, textAnchor.getValue(), x, y + (22 * i++), 0xFFFFFFFF);
            GuiComponent.drawString(matrices, minecraft.font, textAlign .getValue(), x, y + (22 * i++), 0xFFFFFFFF);
            GuiComponent.drawString(matrices, minecraft.font, textOffset.getValue(), x, y + (22 * i++), 0xFFFFFFFF);
            GuiComponent.drawString(matrices, minecraft.font, textScale .getValue(), x, y + (22 * i++), 0xFFFFFFFF);
            // @formatter:on
