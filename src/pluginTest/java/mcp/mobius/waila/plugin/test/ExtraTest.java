...
public enum ExtraTest implements IDataProvider<ChestBlockEntity> {
    ...
    public static final Identifier ENERGY = Identifier.parse("test:energy");
    public static final Identifier ENERGY_INF_STORED = Identifier.parse("test:energy.inf_stored");
    public static final Identifier ENERGY_INF_CAPACITY = Identifier.parse("test:energy.inf_capacity");

    public static final Identifier FLUID = Identifier.parse("test:fluid");
