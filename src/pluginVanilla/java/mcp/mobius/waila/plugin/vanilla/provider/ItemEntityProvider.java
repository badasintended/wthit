...
public enum ItemEntityProvider implements IEntityComponentProvider {
    ...
    private static final ResourceLocation AUTHOR = Options.withSuffix(Options.BOOK_DETAILS, ".author");
    private static final ResourceLocation GENERATION = Options.withSuffix(Options.BOOK_DETAILS, ".generation");
